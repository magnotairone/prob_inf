...
::: {.callout-tip title="Perspectiva de Data Science: $\mathbb{P}(A|B)$ como uma Métrica Filtrada"}
...
::: {.callout-tip title="Perspectiva de Data Science: A Lei da Média Ponderada"}
...
::: {.callout-tip title="Perspectiva de Data Science: Teorema de Bayes, O Motor da Inferência"}
...
<!-- TODO: verificar -->
::: {.callout-tip title="Perspectiva de Data Science: A Hipótese Nula de um Teste A/B"}
